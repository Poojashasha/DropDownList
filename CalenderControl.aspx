<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CalenderControl.aspx.cs" Inherits="DropDownList.CalenderControl" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:ImageButton ID="ImageButton1" runat="server" Height="16px" ImageUrl="~/images/calender.png" OnClick="ImageButton1_Click" />
            <br />
